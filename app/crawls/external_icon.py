...
regex_content_include_pattern = r'data-hds-icon-start="link-external"' # Filter only pages that have at least one form
...
def custom_soup_and_loop_logic(spider, response_body, url, BeautifulSoup):
    ...
    css_selector = '[data-hds-icon-start="link-external"]'
    ...
    for match in matches:
        ...
        yield {
            'url': url,
            "inner_html": inner_html,  # Get inner HTML
